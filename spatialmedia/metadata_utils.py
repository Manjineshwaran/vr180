...
SPHERICAL_XML_CONTENTS_FISHEYE = \
    "<GSpherical:Spherical>true</GSpherical:Spherical>"\
    "<GSpherical:Stitched>true</GSpherical:Stitched>"\
    "<GSpherical:StitchingSoftware>"\
    "Spherical Metadata Tool"\
    "</GSpherical:StitchingSoftware>"\
    "<GSpherical:ProjectionType>fisheye</GSpherical:ProjectionType>"
...
def generate_spherical_xml(projection="equiretangular", stereo=None, crop=None):
    ...
    # Select the appropriate projection XML content
    if projection == "equirectangular":
        projection_xml = SPHERICAL_XML_CONTENTS
    elif projection == "fisheye":
        projection_xml = SPHERICAL_XML_CONTENTS_FISHEYE
    else:
        projection_xml = NOT_SPHERICAL_XML_CONTENTS
